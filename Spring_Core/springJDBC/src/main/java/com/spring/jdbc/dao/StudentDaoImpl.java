...
public class StudentDaoImpl implements StudentDao {
	...
	public List<Student> getAllStudent() {
		...
		List<Student> list = this.jdbcTemplate.query(q, rimpl);
		/*
		 * . The method is typically used to retrieve a single object or record from the
		 * database, not a list. If you're expecting multiple rows (students) from the
		 * database query, you should use the method instead of .
		 */
		return list;
	}
